...
try {
    ...
    & $mkcert -install
    & $mkcert "*.aflglobal.localhost"
    & $mkcert "*.aflglobalsiteb.localhost"
    & $mkcert "aflglobal.xmcloudcm.localhost"
...
Add-HostsEntry "aflglobal.xmcloudcm.localhost"
Add-HostsEntry "www.aflglobal.localhost"
Add-HostsEntry "www.aflglobalsiteb.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "aflglobal.xmcloudcm.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.aflglobal.localhost"
    Set-EnvFileVariable "RENDERING_HOST_SITEB" -Value "www.aflglobalsiteb.localhost"
